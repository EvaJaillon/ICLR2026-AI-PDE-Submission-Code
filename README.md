...
## Code Release Notice
The full source code is currently being cleaned. 
...
* **Ploting code for figures such as the loss function, solutions and errors for the case detailed in the paper
